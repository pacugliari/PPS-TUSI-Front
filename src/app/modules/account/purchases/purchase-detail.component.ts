            ...
            <tfoot class="text-slate-800">
              ...
              <tr>
                ...
                <td class="px-4 py-1 text-right">
                  {{ data.subtotalBruto | currency : 'ARS' : 'symbol-narrow' : '1.2-2' }}
                </td>
              </tr>
              ...
              @if (data.descuentoCupon && data.descuentoCupon > 0) {
                <tr class="text-green-700">
                  <td colspan="4" class="px-4 py-1 text-right">
                    Descuento cupón
                    @if (data.porcentajeCupon) {
                      ({{ data.porcentajeCupon }}%)
                    }
                  </td>
                  <td class="px-4 py-1 text-right">
                    -{{ data.descuentoCupon | currency : 'ARS' : 'symbol-narrow' : '1.2-2' }}
                  </td>
                </tr>
              }
              ...
              @if (data.descuentoBanco && data.descuentoBanco > 0) {
                <tr class="text-green-700">
                  <td colspan="4" class="px-4 py-1 text-right">
                    Descuento promo bancaria
                    @if (data.porcentajeBanco) {
                      ({{ data.porcentajeBanco }}%)
                    }
                  </td>
                  <td class="px-4 py-1 text-right">
                    -{{ data.descuentoBanco | currency : 'ARS' : 'symbol-narrow' : '1.2-2' }}
                  </td>
                </tr>
              }
              ...
              <tr>
                ...
                <td class="px-4 py-1 text-right">
                  {{ data.baseImponible | currency : 'ARS' : 'symbol-narrow' : '1.2-2' }}
                </td>
              </tr>
