          ...
          <div class="rounded-lg border border-slate-200 shadow-sm bg-white">
            ...
            >
              ...
              <mat-form-field appearance="outline">
                ...
                <mat-select formControlName="idZona" required>
                  ...
                  <mat-option [value]="z.idZona">
                    {{ z.nombre }} — {{ z.ciudad || 's/ciudad' }} -
                    {{ z.provincia || 's/provincia' }} @if (z.costoEnvio !=
                    null) { —
                    {{
                      z.costoEnvio
                ...
                <mat-error
                  *ngIf="direccionForm.get('idZona')?.hasError('required')"
                  >Requerido</mat-error
                >
              </mat-form-field>
              ...
              <mat-form-field appearance="outline">
                ...
                <mat-error
                  *ngIf="direccionForm.get('direccion')?.hasError('required')"
                  >Requerido</mat-error
                >
              </mat-form-field>
              ...
              <mat-form-field appearance="outline">
                ...
                <mat-error
                  *ngIf="direccionForm.get('localidad')?.hasError('required')"
                  >Requerido</mat-error
                >
              </mat-form-field>
