...
export class CarouselMarca {
  ...
  static adaptDtoToFormData(dto: CarouselMarcaUpsertDto): FormData {
    const form = new FormData();

    form.append('nombre', dto.nombre);

    if (dto.orden !== undefined && dto.orden !== null) {
      form.append('orden', String(dto.orden));
    }

    if (dto.file instanceof File) {
      form.append('foto', dto.file);
    }
