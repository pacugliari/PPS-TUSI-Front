...
@Component({
  ...
  template: `
      ...
      <div class="container mx-auto flex justify-between items-center py-4">
        ...
        <nav class="hidden lg:flex md:flex-grow justify-center">
          <ul class="flex justify-center space-x-4 text-white">
            <li>
              <a href="index.html" class="hover:text-secondary font-semibold"
                >Home</a
              >
            </li>
            ...
            <li class="relative group" x-data="{ open: false }">
              <a
                href="shop.html"
                (mouseover)="openMen = true"
                (mouseleave)="openMen = false"
                href="#"
            ...
            <li class="relative group" x-data="{ open: false }">
              <a
                href="shop.html"
                (mouseover)="openWomen = true"
                (mouseleave)="openWomen = false"
                href="#"
                class="hover:text-secondary font-semibold flex items-center"
              >
                Women
            ...
            <li>
              <a href="checkout.html" class="hover:text-secondary font-semibold"
                >Checkout</a
              >
            </li>
          </ul>
    ...
    >
      <ul class="w-full">
        <li>
          <a href="index.html" class="hover:text-secondary font-bold block py-2"
            >Home</a
          >
        </li>
        ...
        <li>
          <a href="shop.html" class="hover:text-secondary font-bold block py-2"
            >Shop</a
          >
        </li>
        <li>
        ...
        <li>
          <a href="404.html" class="hover:text-secondary font-bold block py-2"
            >404 page</a
          >
        </li>
        <li>
        ...
        <div class="flex flex-wrap -mx-4">
          ...
          <div class="w-full sm:w-1/6 px-4 mb-8">
            ...
            <ul>
              ...
              <li>
                <a href="/single-product-page.html" class="hover:text-primary"
                  >Women</a
                >
              </li>
          ...
          <div class="w-full sm:w-1/6 px-4 mb-8">
            ...
            <ul>
              ...
              <li>
                <a href="/checkout.html" class="hover:text-primary">Checkout</a>
              </li>
          ...
          <div class="w-full sm:w-1/6 px-4 mb-8">
            ...
            <ul>
              ...
              <li>
                <a href="/register.html" class="hover:text-primary">Login</a>
              </li>
            </ul>
          </div>
          <!-- Social Media -->
