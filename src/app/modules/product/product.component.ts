          ...
          <div class="container mx-auto flex justify-between items-center py-4">
            ...
            <nav class="hidden lg:flex md:flex-grow justify-center">
              <ul class="flex justify-center space-x-4 text-white">
                ...
                <li>
                  <a href="shop.html" class="hover:text-secondary font-semibold"
                    >Shop</a
                  >
                </li>
                <li>
                ...
                <li>
                  <a href="404.html" class="hover:text-secondary font-semibold"
                    >404 page</a
                  >
                </li>
                <li>
            ...
            <li class="relative group" x-data="{ open: false }">
              ...
              >
                ...
                <span (click).stop="open = !open">
                  <i
                    :class="open ? 'fas fa-chevron-up text-xs ml-2' : 'fas fa-chevron-down text-xs ml-2'"
                  ></i>
                </span>
              </a>
              <ul
        ...
        <section id="breadcrumbs" class="pt-6 bg-gray-50">
          <div class="container mx-auto px-4">
            <ol class="list-reset flex">
              <li>
                <a href="index.html" class="font-semibold hover:text-primary"
                  >Home</a
                >
              </li>
              <li><span class="mx-2">&gt;</span></li>
              <li>
                <a href="shop.html" class="font-semibold hover:text-primary"
                  >Shop</a
                >
              </li>
              <li><span class="mx-2">&gt;</span></li>
              <li>
                <a href="category.html" class="font-semibold hover:text-primary"
                  >T-shirts</a
                >
              </li>
              <li><span class="mx-2">&gt;</span></li>
                ...
                <div class="w-full lg:w-1/2 flex flex-col justify-between">
                  <div class="pb-8 border-b border-gray-line">
                    ...
                    <div class="flex items-center mb-8">
                      ...
                      <a href="#" class="ml-4 text-primary font-semibold"
                        >Write a review</a
                      >
                    </div>
                    ...
                    <div class="flex items-center mb-8">
                      ...
                      <input
                        ...
                        type="number"
                        value="1"
                        class="w-16 py-2 text-center focus:outline-none"
                        readonly
                      />
                      <button
                        id="increase"
                    ...
                    <div class="flex flex-col lg:flex-row lg:space-x-8">
                      <div class="w-full lg:w-1/2">
                        <h3 class="text-xl font-semibold mb-2">
                          With the new fashion trends and all the available
                          shopping options, you can order your clothes online
                          and make money without even leaving your house.
                        </h3>
                        <p class="mb-4">
                          These days, you can take your own inspiration and
                          create something new for yourself. All you need to do
                          is read books and magazines about fashion, watch
                          videos on YouTube, keep yourself updated on social
                      ...
                      <div class="w-full lg:w-1/4">
                        ...
                        <p class="mb-2 pb-2 border-b border-gray-line">
                          Fabric: <span class="font-semibold">Soft jersey</span>
                        </p>
                        <p class="mb-2">
                          Care instructions:
                          <span class="font-semibold"
                            >Machine wash at 30°C, do not tumble dry, iron on
                            low heat, do not bleach</span
                          >
                        </p>
                      </div>
                      <div class="w-full lg:w-1/4">
                        ...
                        <p class="mb-2 pb-2 border-b border-gray-line">
                          Model height:
                          <span class="font-semibold"
                            >Our model is 180 cm tall and is wearing size
                            M</span
                          >
                        </p>
                        <p class="mb-2 pb-2 border-b border-gray-line">
                          Fit: <span class="font-semibold">Regular</span>
                        </p>
                        <p class="mb-2 pb-2 border-b border-gray-line">
                          Length: <span class="font-semibold">Standard</span>
                        </p>
                        <p class="mb-2">
                          Sleeve length:
                    ...
                    <div class="flex flex-col space-y-8">
                      ...
                      <div>
                        ...
                        <p class="text-base text-gray-700">
                          Material: 100% Cotton
                          <br />
                          Care instructions: Machine wash at 40 °C, do not
                          tumble dry, iron at medium temperature, do not bleach.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="space-y-6">
                      ...
                      <div id="reviews-list">
                        ...
                        <div class="py-4">
                          ...
                          <p>
                            Great quality! Fits perfectly and the material feels
                            premium. Highly recommend this t-shirt.
                          </p>
                        </div>
                        <!-- Review 2 -->
                        <div class="border-t border-gray-line py-4">
                          ...
                          <p>
                            ...
                            comfortable. However, I wish it came in more colors.
                          </p>
                        </div>
                        <!-- Review 3 -->
                        <div class="border-t border-gray-line py-4">
                          ...
                          <p>
                            Excellent t-shirt! The size is perfect and it looks
          ...
          <div class="container mx-auto px-4 py-10">
            <div class="flex flex-wrap -mx-4">
              ...
              <div class="w-full sm:w-1/6 px-4 mb-8">
                ...
                <ul>
                  <li>
                    <a href="/shop.html" class="hover:text-primary">Shop</a>
                  </li>
                  <li>
                    <a
                      href="/single-product-page.html"
                  ...
                  <li>
                    <a href="/shop.html" class="hover:text-primary">Men</a>
                  </li>
                  <li>
                    <a
                      href="/single-product-page.html"
              ...
              <div class="w-full sm:w-1/6 px-4 mb-8">
                ...
                <ul>
                  ...
                  <li>
                    <a href="/404.html" class="hover:text-primary">404</a>
                  </li>
                </ul>
              </div>
              <!-- Menu 3 -->
