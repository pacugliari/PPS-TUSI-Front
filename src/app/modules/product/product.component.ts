    ...
    <section id="breadcrumbs" class="pt-6 bg-gray-50">
      <div class="container mx-auto px-4">
        <ol class="list-reset flex">
          <li>
            <a routerLink="/" class="font-semibold hover:text-primary"
              >Home</a
            >
          </li>
          ...
          <li><span class="mx-2">&gt;</span></li>
          <li>
            <a routerLink="/product" class="font-semibold hover:text-primary"
              >T-shirts</a
            >
          </li>
          <li><span class="mx-2">&gt;</span></li>
            ...
            <div class="w-full lg:w-1/2 flex flex-col justify-between">
              <div class="pb-8 border-b border-gray-line">
                ...
                <div class="mb-4 pb-4 border-b border-gray-line">
                  <p class="mb-2">
                    Brand:<strong
                      ><a href="#" class="hover:text-primary"> Nike</a></strong
                    >
                  </p>
                ...
                <div class="flex flex-col lg:flex-row lg:space-x-8">
                  <div class="w-full lg:w-1/2">
                    <h3 class="text-xl font-semibold mb-2">
                      ...
                      options, you can order your clothes online and make money
                      without even leaving your house.
                    </h3>
                    <p class="mb-4">
                      These days, you can take your own inspiration and create
                      something new for yourself. All you need to do is read
                      books and magazines about fashion, watch videos on
                      YouTube, keep yourself updated on social media, and, of
                      course, shop online!
                    </p>
                  </div>
                  ...
                  <div class="w-full lg:w-1/4">
                    ...
                    <p class="mb-2 pb-2 border-b border-gray-line">
                      Model height:
                      <span class="font-semibold"
                        >Our model is 180 cm tall and is wearing size M</span
                      >
                    </p>
                    <p class="mb-2 pb-2 border-b border-gray-line">
                ...
                <div class="space-y-6">
                  ...
                  <div id="reviews-list">
                    ...
                    <div class="border-t border-gray-line py-4">
                      ...
                      <p>
                        I love the design and the fabric is very comfortable.
                        However, I wish it came in more colors.
                      </p>
                    </div>
                    <!-- Review 3 -->
                    <div class="border-t border-gray-line py-4">
