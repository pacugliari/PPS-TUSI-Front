      ...
      <div class="container mx-auto px-4 py-10">
        <div class="flex flex-wrap -mx-4">
          ...
          <div class="w-full sm:w-1/6 px-4 mb-8">
            ...
            <ul>
              <li><a routerLink="/shop" class="hover:text-primary">Shop</a></li>
              <li>
                <a routerLink="/product" class="hover:text-primary"
                  >Women</a
                >
              </li>
              <li><a routerLink="/shop" class="hover:text-primary">Men</a></li>
              <li>
                <a routerLink="/product" class="hover:text-primary"
                  >Shoes</a
                >
          ...
          <div class="w-full sm:w-1/6 px-4 mb-8">
            ...
            <ul>
              ...
              <li>
                <a routerLink="/checkout" class="hover:text-primary">Checkout</a>
              </li>
              <li><a routerLink="/**" class="hover:text-primary">404</a></li>
            </ul>
          </div>
          <!-- Menu 3 -->
          <div class="w-full sm:w-1/6 px-4 mb-8">
            ...
            <ul>
              ...
              <li>
                <a routerLink="/register" class="hover:text-primary"
                  >Registration</a
                >
              </li>
              <li>
                <a routerLink="/register" class="hover:text-primary">Login</a>
              </li>
            </ul>
          </div>
          <!-- Social Media -->
